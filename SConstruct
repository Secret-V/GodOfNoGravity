...
for root, dirs, files in os.walk("./src/"):
    for file in files:
        ...
        with open("./gdnstemplate.gdns") as f:
            ...
            newFilename = "project/bin/" + basename + ".gdns"
...
lines = None
included = []
with open("./src/gdlibrary.cpp", 'r') as f:
    lines = f.readlines()
...
with open("./src/gdlibrary.cpp", 'w') as f:
    f.write(output)
...
opts.Add(PathVariable('target_name', 'The library name.', 'libgodofnogravity', PathVariable.PathAccept))
